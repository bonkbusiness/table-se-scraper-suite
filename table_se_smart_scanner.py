...
def smart_scan_products(products: List[Dict[str, Any]], required_fields=None, anomaly_field="Pris inkl. moms (värde)", anomaly_z=3.5, review_export=True) -> Tuple[List[Dict[str, Any]], List[List[str]]]:
    """
